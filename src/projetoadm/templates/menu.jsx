...
import Profile from '../components/microProfilePhoto/profile'
...
<>
        ...
        <div class="logo">
        <a href="#/home">
        <img src="assets/images/logo.png" alt="Your logo" title="Your logo" class="img-fluid"  />
        </a>
        </div>
        ...
        <div class="navbar user-panel-top">
            ...
            <ul>
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdownMenu3" aria-haspopup="true"
                    ...
                    <Profile caminho="assets/images/profileimg.jpg" classe="rounded-circle" />
